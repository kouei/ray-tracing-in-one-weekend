...
__global__ void new_world(hittable_list *world) {
  ...
  material *material_center = new lambertian(color(0.7f, 0.3f, 0.3f));
  material *material_left = new metal(color(0.8f, 0.8f, 0.8f), 0.3f);
  material *material_right = new metal(color(0.8f, 0.6f, 0.2f), 1.0f);
